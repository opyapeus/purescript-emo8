...
instance objectDrawEnemyBullet :: ObjectDraw EnemyBullet where
    draw o@(NormalBull _) = emor (-40) Pushpin (size o) (position o).x (position o).y
    draw o@(ParseBull s) = emor (10 * s.t) Hammer (size o) (position o).x (position o).y
