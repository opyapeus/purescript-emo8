...
import Emo8.Types (MonitorSize, Size)
...
startupView ms ctx = do
  ...
  fillText ctx "E" (xRatio 0.3) (yRatio 0.5)
  setFillStyle ctx (colorToCode Aqua)
  fillText ctx "M" (xRatio 0.42) (yRatio 0.5)
  setFillStyle ctx (colorToCode Fuchsia)
  fillText ctx "O" (xRatio 0.52) (yRatio 0.5)
  setFillStyle ctx (colorToCode Yellow)
  fillText ctx "8" (xRatio 0.65) (yRatio 0.5)
  restore ctx
  where
    w = toNumber ms.width
